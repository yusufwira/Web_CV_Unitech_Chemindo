          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">                      
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <h5>Satuan</h5>
                    <input type="text" class="form-control form-control-user" id="satuan" id="exampleInputEmail" placeholder="/Pcs">    
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-8"> 
                    <h5>Input Stock</h5>
                    <input type="text" class="form-control form-control-user" id="stock" id="exampleInputEmail">
                  </div>                  
                </div>
   ...
   <script type="text/javascript">
    function tambahData(){    
      ...
      $.ajax({
        type:"POST",
        url:"process.php",
        data:{isinya: "tambah", nama: nama, satuan: satuan, stock: stock},
