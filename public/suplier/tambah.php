          ...
          <div class="card shadow mb-4">
            ...
            <div class="col-sm-3"></div>
                <div class="form-group col-sm-9 ">
                  <div class="col-sm-8"> 
                    <h5>Nama Suplier</h5>
                    <input type="text" class="form-control form-control-user" id="nama" id="exampleInputEmail">
                  </div>
                  <div class="col-sm-8">
                    <h5>Alamat</h5>
                    <input style="height: 100px" type="text" class="form-control form-control-user" id="alamat" id="exampleInputEmail" >    
                  </div>
                  <div class="col-sm-8">
                    <h5>No. Telp</h5>
                    <input type="text" class="form-control form-control-user" id="notelp" id="exampleInputEmail" >    
                  </div>
                  <br>
                  <div class="col-sm-8">
   ...
   <script type="text/javascript">
    function tambahData(){    
      ...
      $.ajax({
        type:"POST",
        url:"process.php",
        data:{isinya: "tambah", nama: nama, alamat: alamat, notelp: notelp},
