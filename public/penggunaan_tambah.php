          ...
          <!-- DataTales Example -->
           <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-plus"></i> Penggunaan Barang</h6>
            </div>
    ...
    function tambahData(){       
     ...
     var tanggal = $('#tanggal').val();    
      $.ajax({
        type:"POST",
        url:"process.php",
        data:{isinya: "tambah_penggunaan", barang: barang, jumlah: jumlah, tanggal:tanggal},
